        ...
        <div class="add_content">
            ...
            <div class="add_box">
                ...
                <div class="a textarea_box input_box">
                    <textarea name="text" placeholder="{{ $errors->first('text') }}">{{ old('text') }}</textarea>
                </div>
            </div>
            <div class="add_box">
                <div class="a">
                ...
                <div class="a  input_box logo_box">
                    ...
                    <label for="upload_logo" class='img_label'>
            ...
            <div class="add_box">
                ...
                <div class="a phone_box">
                    ...
                    <div class="contact_box contact_inp">
                        <input type="text" name="phone1" class="validate" value="{{ old('phone1') }}"
                            placeholder="{{ $errors->first('phone1') }}" />
                    </div>
                </div>
                <div class="a phone_box">
                    <div class="contact_box ">
                    ...
                    <div class="contact_box contact_inp">
                        <input type="text" name="phone2" class="validate" value="{{ old('phone2') }}" />
                    </div>
                </div>
            </div>
            <div class="add_box">
            ...
            <div class="add_box">
                ...
                <div class="a phone_box">
                    ...
                    <div class="contact_box contact_inp">
                        <input type="text" name="viber" class="validate" value="{{ old('viber') }}" />
                    </div>
                </div>
            </div>
            <div class="add_box">
            ...
            <div class="add_box">
                ...
                <div class="a phone_box">
                    ...
                    <div class="contact_box contact_inp">
                        <input type="url" name="site_url" value="{{ old('site_url') }}" />
                    </div>
                </div>
            </div>
            <div class="add_box">
